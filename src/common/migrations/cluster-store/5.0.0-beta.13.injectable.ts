...
import type { ClusterModel, ClusterPreferences, ClusterPrometheusPreferences } from "../../cluster-types";
...
function getMigration({ userDataPath }: Dependencies): MigrationDeclaration {
  return {
...
const version500Beta13MigrationInjectable = getInjectable({
...
export default version500Beta13MigrationInjectable;
