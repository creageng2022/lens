...
import directoryForKubeConfigsInjectable from "../../app-paths/directory-for-kube-configs.injectable";
...
function getMigration({ userDataPath, kubeConfigsPath }: Dependencies): MigrationDeclaration {
  return {
