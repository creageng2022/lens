...
import type { HelmRelease, IReleaseDetails, IReleaseUpdateDetails, IReleaseUpdatePayload } from "../../../../common/k8s-api/endpoints/helm-release.api";
        ...
        <React.Fragment key={kind}>
          ...
          <Table scrollable={false}>
            ...
            {items.map(item => {
              ...
              const api = this.props.apiManager.getApi(api => api.kind === kind && api.apiVersionWithGroup == item.apiVersion);
...
export const ReleaseDetails = withInjectables<Dependencies, Props>(NonInjectedReleaseDetails, {
  getProps: (di, props) => ({
