...
import type { IChartInstallData } from "./install-chart.store";

let storage: StorageLayer<DockTabStorageState<IChartInstallData>>;

const installChartStoreStorageInjectable = getInjectable({
  setup: async (di) => {
...
export default installChartStoreStorageInjectable;
