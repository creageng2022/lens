...
export interface EditResourceStoreDependencies extends DockTabStoreDependencies<EditingResource> {
...
export class EditResourceStore extends DockTabStore<EditingResource> {
  ...
  constructor(protected readonly dependencies: EditResourceStoreDependencies) {
    super(dependencies);
    autoBind(this);
