...
import type { LogsViewModel } from "./logs-view-model";
...
@observer
class NonInjectedLogs extends React.Component<LogsProps & Dependencies> {
...
export const LogsDockTab = withInjectables<Dependencies, LogsProps>(NonInjectedLogs, {
  getProps: (di, props) => ({
